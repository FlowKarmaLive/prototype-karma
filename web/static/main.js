...
var $author$project$Main$RecvHash = function (a) {
	return {$: 'RecvHash', a: a};
};
...
var $author$project$Main$getHash = function (url) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$emptyBody,
			expect: $elm$http$Http$expectString($author$project$Main$RecvHash),
			url: A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$DownloadNewKey),
								$elm$html$Html$Attributes$class('pure-button')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Download key cert file to let a friend join.')
							]))
					]))
			]),
